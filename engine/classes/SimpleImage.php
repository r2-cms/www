<?php
	...
	*/
	...
	class SimpleImage extends GT8 {
		...
		function output($image_type=null, $retrieveData=false) {
			if ( $image_type == null) {
				$image_type	= $this->image_type;
			}
			//se o param $retrieveData for verdadeiro, capture o buffer para retorná-lo no fim da fx
