<?php
	if ( !defined('SROOT')) {
		die('Root not defined in SmtpMailer!');
	}
	...
	class PHPMailer extends GT8 {
		...
		public $ErrorInfo		= '';
		public $From			= 'contato@gt8.com.br';
		public $FromName		= 'Roger';
		public $Sender			= '';
		public $Subject			= '';
		public $Body			= '';
		public $AltBody			= '';
		...
		public function AddAttachment($path, $name = '', $encoding = 'base64', $type = 'application/octet-stream') {
			try {
				...
				6 => 'attachment', 7 => count( $this->attachment )  );
			} catch (phpmailerException $e) {
				$this->SetError($e->getMessage());
				if ($this->exceptions) {
					throw $e;
		...
		public function AddStringAttachment($string, $filename, $encoding = 'base64', $type = 'application/octet-stream') {
			...
			$this->attachment[] = array(0 => $string, 1 => $filename, 2 => $filename, 3 => $encoding, 4 => $type, 5 => true, // isStringAttachment
			6 => 'attachment', 7 => 0);
		}
	...
	class phpmailerException extends Exception {
		public function errorMessage() {
			...
			if ( isset($_SESSION['login']) && $_SESSION['login']['level'] > 6 ) {
